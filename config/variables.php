<?php
  ...
  return [
    ...
    "creatorUrl" => "·",
    "templateName" => "Perneria Aqui me Quedo",
    "templateSuffix" => "Administración de Ferreteria",
    "templateVersion" => "2.0",
    "templateFree" => false,
    "templateDescription" => "Administracion de Ferreteria",
    "templateKeyword" => "Para empresa de Ferreteria",
